...
const TalentCard = ({ talent }: { talent: Talent }) => {
	return (
		<div className="divide-y max-w-md divide-gray-200 overflow-hidden rounded-lg bg-white shadow">
			...
			<div className="px-4 py-5 sm:p-6">
				<div className="flex flex-wrap justify-between">
					<button className="bg-red-500 hover:scale-105 transition-all px-4 py-2 rounded-md text-white">
						Delete
					</button>
